  ...
  <div class="menu-bar">
    <transition name="slide-up">
      <div class="menu-wrapper" :class="{'hide-box-shadow': ifSettingShow || !ifTitleAndMenuShow}" v-show="ifTitleAndMenuShow">
        ...
        <div class="icon-wrapper">
          <span class="iconfont icon-Progressread" @click="showSetting(2)"></span>
        </div>
        <div class="icon-wrapper">
          <span class="iconfont icon-brightness" @click="showSetting(1)"></span>
        </div>
        <div class="icon-wrapper">
          <span class="iconfont icon" @click="showSetting(0)">A</span>
        </div>
      </div>
    </transition>
    <transition name="slide-up">
